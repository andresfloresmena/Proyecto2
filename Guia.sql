...
insert into Usuario (cedula,clave,nombre,telefono,correo,pago,tipo) 
	values ("111","111","Juan Perez","1234567890","juan.perez@gmail.com","Pago1",1);

insert into Usuario (cedula,clave,nombre,telefono,correo,pago,tipo) 
	values ("222","222","Bruce Banner","0987654321","bruce.banner@gmail.com","Pago2",1);

insert into Usuario (cedula,clave,nombre,telefono,correo,pago,tipo) 
	values ("333","333","Clark Kent","1122334455","clark.kent@gmail.com","Pago3",2);
